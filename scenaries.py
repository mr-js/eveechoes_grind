...
def scenary_check_around(grind):
     # DEMO
     # HELP fir fuction "template_calibrate"
     help(grind.template_calibrate)
     # DEMO
...
try:
     grind.log.info('Scenaries started')
     ...
     grind.log.info('Scenaries finished')
except Exception as e:
     grind.log.error(f'ERROR: {e}')
finally:
